...
<nav style="background-color:#0dcaf0" class="navbar navbar-expand-lg navbar-light">
    ...
    <a class="navbar-brand" style="color:white">The Gymbo Resto</a>
    <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarSupportedContent"
        aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
        <span class="navbar-toggler-icon"></span>
    </button>
    
    <a class="nav-item <?php if($_GET['halaman'] == "catatan") {echo"active";} ?>">
		<a class="icon-link icon-link-hover" href="?halaman=catatan">
		<i class="fas fa-print"></i>
			<span style="color:white">Catatan Transaksi</span></a>
