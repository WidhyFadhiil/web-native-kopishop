    ...
    if(isset($_POST['simpan']))
    {
        ...
        if($cek > 0)
        {
            if(password_verify($_POST['password'],$data['password']))
            {
                ...
                {
                    header("location:manager.php?halaman=barang");
                } 
...
<title>The Gymbo Caffe</title>
<link rel="icon" type="img" href="logokopi.png">
...
<body style="background-image: url('bgkopi1.avif')">
        ...
        <div class="card-body p-0">
            ...
            <div class="col-lg-12">
                ...
                <form class="user" method="post" action="">
                    ...
                    <button type="submit" name="simpan" class="btn btn-info btn-user btn-block">Login</button>
                </form>
                </div>
            </div>
            </div>
