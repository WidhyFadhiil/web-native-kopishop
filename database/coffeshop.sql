...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 04, 2024 at 10:49 AM
...
(5, 16, 'wibi', '5613436547', 'Kasir', 'input data user', '2024-02-04 07:07:42'),
(6, 17, 'anugrah', '56546433523434', 'Manager', 'input data user', '2024-02-04 07:08:27');
...
('P000004', '16', '2024-02-04', 40000, 25000, 15000);
...
(16, 'wibi', '5613436547', 'jakarta', 'Kasir', 'kasir', '$2y$10$sUIHQVbXk5bCC1bZQpGDJuOwK5yYDx9fNut6YJTPlOjBIUyKaW6Mq'),
(17, 'anugrah', '56546433523434', 'jakarta', 'Manager', 'manager', '$2y$10$1tPDb/DrcEVPBFvYXCU0we5E18Zrp7YoVTcpTCdAtj2MgOwQGgEJK');
...
--
ALTER TABLE `detail_penjualan`
  MODIFY `kode_detail_penjualan` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
...
--
ALTER TABLE `log_aktifitas`
  MODIFY `id_log_aktifitas` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT for table `user`
--
ALTER TABLE `user`
  MODIFY `kode_user` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
COMMIT;
